...
****
Similarly to our xref:redis.repositories:mapping.fundamentals.adoc#mapping.object-creation.details[optimizations in object construction] we also use Spring Data runtime generated accessor classes to interact with the entity instance.
