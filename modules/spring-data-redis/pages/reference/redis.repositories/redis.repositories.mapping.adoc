...
NOTE: Custom conversions have no effect on index resolution. xref:redis.repositories:redis.repositories.indexes.adoc#redis.repositories.indexes[redis.repositories.indexes] are still created, even for custom converted types.
