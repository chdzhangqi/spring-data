...
Again, for more complex expressions, you should use a Spring bean and let the expression invoke a method, as described  xref:projections:projections.interfaces.adoc#projections.interfaces.open.bean-reference[earlier].
